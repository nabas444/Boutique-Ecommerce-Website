...
export default function ProductCard({ product, compact = false, hideSoldOutBadge = false }) {
  ...
  return (
    <Link
      to={`/products/${product.slug}`}
      className="group block bg-white rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300"
    >
      {/* Image area */}
      ...
      <div className="p-4">
        ...
        <p className="text-sm font-semibold text-stone-900 leading-tight mb-2 line-clamp-1">
          {product.name}
        </p>
